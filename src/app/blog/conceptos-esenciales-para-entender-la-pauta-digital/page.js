        ...
        <Section>
          <div className="flex flex-col mt-[32px] justify-center items-center">
            <h1 className="text-[38px] lg:text-5xl 2xl:text-6xl text-center font-bold">
              Conceptos clave de la pauta digital
            </h1>
            <br />
            <div className="flex flex-col max-w-5xl">
              <br />
              <p className="text-left text-sm lg:text-base 2xl:text-lg leading-8">
                Sabemos que entrar al mundo de la pauta digital puede sentirse
                como hablar en otro idioma. Que si el CPC, que si el alcance,
                que si el algoritmo. Tranquilo, no estás solo.
                <br />
                <br />
                En este blog vamos a contarte (sin tanto enredo) qué significan
                los conceptos que más se usan en pauta, por qué son importantes
                y cómo los trabajamos desde una agencia de pauta digital.
                <br />
                <br />
                Así que prepárate, saca lápiz y papel, y un poco de cariñito que
                vamos por partes.
              </p>
              <br />
