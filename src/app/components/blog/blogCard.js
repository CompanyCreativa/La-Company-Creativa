...
export default function BlogCard({ post }) {
  return (
    <Link href={post.link} passHref legacyBehavior>
      <a className="w-full block min-h-[600px] relative border border-[#f5f5f5] rounded-lg overflow-hidden group">
        <Image
          src={post.image}
          alt={post.title}
        ...
        <div className="w-full absolute bottom-0 px-7 py-4 flex flex-col justify-between bg-gradient-to-t from-[#000000] to-[rgba(0,0,0,0.5)] rounded-b-lg">
          <div className="flex flex-col gap-5">
            ...
            <div className="w-full flex justify-between items-center">
              ...
              <span className="font-bold font-abel tracking-wider text-[#fff8ea] text-lg flex justify-center items-center gap-1">
                Leer más
