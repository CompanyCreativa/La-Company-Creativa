...
export default function ZohoForm() {
  ...
  return (
    <div
      ...
      className="flex-1 w-[100%] lg:w-[50%] mt-10 flex flex-col gap-8 items-end lg:mt-0 lg:pb-16 px-5 lg:px-0"
    >
      ...
      >
        ...
        <div className="my-4 clear-both  flex flex-col">
          <div className="w-[30%] mr-[10px] mt-[5px] float-left">
            <label htmlFor="First_Name" className="text-base font-calibri">
              Nombre
            </label>
          </div>
        ...
        <div className="my-4 clear-both  flex flex-col">
          <div className="w-[30%] mr-[10px] mt-[5px] float-left">
            <label htmlFor="Last_Name" className="text-base font-calibri">
        ...
        <div className="my-4 clear-both  flex flex-col">
          <div className="w-[30%] mr-[10px] mt-[5px] float-left">
            <label htmlFor="Company" className="text-base font-calibri">
              Empresa
            </label>
          </div>
          <div className="float-left">
        ...
        <div className="my-4 clear-both flex flex-col">
          <div className=" mr-[10px] mt-[5px] float-left">
            <label htmlFor="Mobile" className="text-base font-calibri">
        ...
        <div className="my-4 clear-both  flex flex-col">
          <div className=" mr-[10px] mt-[5px] float-left">
            <label htmlFor="Email" className="text-base font-calibri">
